            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 bg-muted/50 rounded-lg space-y-4">
                    ...
                    <Button onClick={() => handleDownload('個人談話記錄', 'class')} disabled={isDownloading || !selectedClass} className="w-full">
                     ...
                     <Button onClick={() => handleDownload('個人談話記錄', 'all')} disabled={isDownloading} variant="secondary" className="w-full">
                        {isDownloading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Download className="mr-2 h-4 w-4" />}
                        下載全校資料
                    </Button>
                </div>
                 <div className="p-4 bg-muted/50 rounded-lg space-y-4">
                    ...
                    <Button onClick={() => handleDownload('家庭聯繫紀錄', 'class')} disabled={isDownloading || !selectedClass} className="w-full">
                     ...
                     <Button onClick={() => handleDownload('家庭聯繫紀錄', 'all')} disabled={isDownloading} variant="secondary" className="w-full">
                        {isDownloading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Download className="mr-2 h-4 w-4" />}
                        下載全校資料
                    </Button>
                </div>
