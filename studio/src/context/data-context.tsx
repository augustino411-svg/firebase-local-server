...
import { getStudents, getClasses, getAllAttendance, getAllCounselingRecords, getUsers } from '@/lib/data-client';
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      // Fetch all data concurrently including users
      const [
        fetchedStudents, 
        fetchedClasses, 
        fetchedAttendance, 
  ...
  return (
    <DataContext.Provider value={{ students, classes, attendanceRecords, counselingRecords, users, loading, refetchData: fetchData }}>
      {children}
